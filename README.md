...
* [`src/clj/checker/`](src/clj/checker/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/cljs/checker/`](src/cljs/checker/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/checker/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `checker` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/checker/config.cljs) defaults to `true` in
...
```clj
(ns checker.example
  (:require [checker.config :as config])
...
```sh
port=2000 java -jar target/checker.jar
```
